...
if __name__ == '__main__':
    ...
    # model = model.load('../../../../../Knolling_bot_2/627_pile_pose/weights/best.pt')
    # # model = model.load('yolov8n-pose.pt')
    # # Train the model
    # model.train(data='knolling_pile_real.yaml', epochs=200, imgsz=640, patience=300, name='828_pile_pose_real_sundry')
